...
ranking. Our system is designed to solve two tasks. For the first task, further referred as task A, the
...
announced the top-10 tweets from the previous episode.

The whole dataset consists of $11,685$ tweets about 106 different topics. Every tweet in the dataset is
